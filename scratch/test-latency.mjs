...
const endpoints = [
  ...
  { name: 'broker-summary', url: 'https://api.sectors.app/v2/broker-summary/BBCA/?start=2026-09-12&end=2026-09-22' },
  ...
  { name: 'shareholders', url: 'https://api.sectors.app/v2/company/report/BBCA/?sections=shareholders' },
  { name: 'segments', url: 'https://api.sectors.app/v2/company/report/BBCA/?sections=segments' },
  { name: 'companies-200', url: 'https://api.sectors.app/v2/companies/?limit=200&order_by=-market_cap' },
]
