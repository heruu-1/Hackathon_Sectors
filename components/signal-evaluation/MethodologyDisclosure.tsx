...
import { ChevronDown, ChevronUp, Clock, Database, HelpCircle, ShieldCheck } from 'lucide-react'
  ...
  return (
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-card)]">
      <button
        ...
        className="flex w-full items-center justify-between p-4 text-left transition-colors hover:bg-[var(--rasi-muted-bg)]/30"
      >
      ...
      {isOpen && (
        <div className="space-y-4 border-t border-[var(--border-subtle)] p-4 pt-0 text-xs leading-relaxed text-[var(--rasi-muted)]">
          <div className="grid grid-cols-1 gap-3 pt-3 md:grid-cols-3">
            <div className="space-y-1.5 rounded-lg border border-[var(--border-subtle)] bg-[var(--rasi-muted-bg)]/20 p-3">
              ...
              <p className="text-[11px]">
                <strong>Senin–Kamis:</strong> Sesi I (09.00–12.00), Sesi II (13.30–15.50 WIB
                eksklusif).
                <br />
                <strong>Jumat:</strong> Sesi I (09.00–11.30), Sesi II (14.00–15.50 WIB eksklusif).
                <br />
                Prapenutupan (15.50–16.00) dan pascapenutupan (16.05–16.15) tidak dihitung dalam bar
                perdagangan kontinu.
              </p>
            </div>
            ...
            <div className="space-y-1.5 rounded-lg border border-[var(--border-subtle)] bg-[var(--rasi-muted-bg)]/20 p-3">
              ...
              <p className="text-[11px]">
                Konteks sinyal dibuat immutable di server untuk mencegah manipulasi harga acuan.
                Harga acuan diambil dari bar penutupan terakhir yang telah selesai saat evaluasi
                dibuat.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-1.5 text-[11px]">
            <p>
              • <strong>Aturan Horizon Sesi:</strong> Untuk sinyal yang muncul saat perdagangan
              berjalan, Horizon 1 adalah akhir sesi kontinu berikutnya (bukan sisa sesi yang sedang
              berlangsung).
            </p>
            <p>
