...
export function ResearchShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="rasi-app relative min-h-screen bg-[var(--rasi-bg)] text-[var(--rasi-text)]">
          ...
          <defs>
            ...
            >
              ...
              <path
                ...
                strokeOpacity="0.28"
              />
              <circle cx="14" cy="158" r="1.6" fill="#ffffff" fillOpacity="0.80" />
      ...
      >
        {/* Top Header */}
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[var(--rasi-border)] bg-[var(--rasi-surface)] px-4 sm:px-6">
